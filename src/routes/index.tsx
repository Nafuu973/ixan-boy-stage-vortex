...
function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative h-[120svh] min-h-[700px] w-full overflow-hidden md:h-[100svh] md:min-h-[600px]"
    >
      <motion.div style={{ y, scale }} className="absolute inset-0">
        <img
          src={heroImg}
          alt="IXAN BOY"
          className="h-full w-full object-cover object-[top_center] md:object-top lg:object-[center_15%]"
          fetchPriority="high"
        />
